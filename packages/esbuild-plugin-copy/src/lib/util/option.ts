...
import type { IConfig, IConfigRename, IConfigTarget, IOptionRename, IOptionTarget, IOptions } from '../types';
 ...
 * @returns
 */
export function normalizeTarget(config: Exclude<IConfig, 'targets'>, target: IOptionTarget): IConfigTarget | never {
